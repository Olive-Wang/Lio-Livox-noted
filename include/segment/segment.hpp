...
//用栅格表示240*80*20空间的点云
#define DN_SAMPLE_IMG_NX 600 //(GND_IMG_NX)  一共x600,y200,z100,存贮0 or 1表示这个栅格内是否有点
#define DN_SAMPLE_IMG_NY 200 //(GND_IMG_NY)
#define DN_SAMPLE_IMG_NZ 100
#define DN_SAMPLE_IMG_DX 0.4 //(GND_IMG_DX)          栅格大小x
#define DN_SAMPLE_IMG_DY 0.4 //(GND_IMG_DY)           栅格大小y
#define DN_SAMPLE_IMG_DZ 0.2   //栅格大小z
#define DN_SAMPLE_IMG_OFFX 40 //(GND_IMG_OFFX)        栅格原点的偏移量，在原始原点坐标系下的坐标为（-40，-40，-2.5）
...
#define FREE_DELTA_ANG (FREE_PI*2/FREE_ANG_NUM) //角度转成弧度制
